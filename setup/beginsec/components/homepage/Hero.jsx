    ...
    <section className="text-white py-16 px-8 md:px-16 lg:px-24 flex flex-col lg:flex-row justify-center items-center gap-x-64 container mx-auto">
      <div className="max-w-lg mb-8 lg:mb-24">
        ...
        <Detail className="font-ibmthai">
          ในยุคที่เทคโนโลยีเติบโตอย่างรวดเร็ว การป้องกันความปลอดภัยทางไซเบอร์ไม่ได้เป็นเพียงหน้าที่ของโปรแกรมเมอร์หรือผู้ดูแลระบบอีกต่อไป แต่เป็นความรับผิดชอบของ “ทุกคน” ที่ใช้งานอินเทอร์เน็ต ไม่ว่าคุณจะเป็นพนักงานทั่วไป นักเรียน หรือเจ้าของกิจการ การรู้เท่าทันภัยคุกคามไซเบอร์และเข้าใจพฤติกรรมดิจิทัลที่ปลอดภัยคือกุญแจสำคัญในการปกป้องตัวคุณเอง
        </Detail>
