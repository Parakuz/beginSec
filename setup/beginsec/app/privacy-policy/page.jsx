      ...
      <div className="min-h-screen bg-gradient-to-br from-[#161831] to-[#0f1022] text-white">
        <div className="max-w-4xl mx-auto px-6 py-16">
          ...
          <p className="text-lg text-gray-300 leading-relaxed mb-10">
            Your privacy is important to us. This Privacy Policy explains how Begin Sec collects, uses, and protects your
          ...
          <div className="space-y-12">
            <Section title="Information We Collect">
              <ul className="space-y-2">
                <ListItem>Personal identification information (Name, email address, etc.)</ListItem>
            ...
            <Section title="Cookies">
              <p className="text-gray-300 leading-relaxed">
                We use cookies to improve your experience on our site. You can choose to disable cookies through your
                browser settings.
              </p>
            </Section>
            ...
            <Section title="Third-Party Services">
              <p className="text-gray-300 leading-relaxed">
                We may employ third-party companies to facilitate our service. These third parties have access to your
                personal information only to perform tasks on our behalf and are obligated not to disclose or use it for
                any other purpose.
              </p>
            </Section>
