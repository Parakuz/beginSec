    ...
    <div className="min-h-screen bg-gradient-to-b from-[#161831] to-[#0c0e1d]">
      ...
      <div className="container mx-auto px-4 py-10">
        ...
        <div className="flex items-center gap-3 mt-8 mb-6">
          ...
          <h2 className="text-white text-2xl font-bold">Let&apos;s start learning</h2>
        </div>
            ...
            {userCourses.map((course) => (
              ...
              >
                ...
                <div className="relative">
                  ...
                  <div className="text-white text-lg font-bold mb-2">{course.name}</div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="bg-purple-900/30 text-purple-300 text-xs px-3 py-1 rounded-full">0% Complete</div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="group relative bg-gradient-to-br from-[#242851] to-[#1e2142] p-5 rounded-xl hover:shadow-xl hover:shadow-purple-900/20 transition-all duration-300 border border-[#3a3f6a]/50 overflow-hidden">
              ...
              <div className="relative">
                ...
                <div className="text-white text-lg font-bold mb-2">Fundamental for Cyber</div>

                <div className="text-gray-300 text-sm mb-4 line-clamp-2">
                  Learn the essential fundamentals of cybersecurity to build a strong foundation.
                </div>

                <div className="flex items-center justify-between">
                  <div className="bg-purple-900/30 text-purple-300 text-xs px-3 py-1 rounded-full">Beginner</div>
            ...
            <div className="group relative bg-gradient-to-br from-[#242851] to-[#1e2142] p-5 rounded-xl hover:shadow-xl hover:shadow-purple-900/20 transition-all duration-300 border border-[#3a3f6a]/50 overflow-hidden">
              ...
              <div className="relative">
                ...
                <div className="text-white text-lg font-bold mb-2">Web Exploit Basic</div>

                <div className="text-gray-300 text-sm mb-4 line-clamp-2">
                  Discover common web vulnerabilities and how to exploit them safely in a controlled environment.
                </div>

                <div className="flex items-center justify-between">
                  <div className="bg-purple-900/30 text-purple-300 text-xs px-3 py-1 rounded-full">Intermediate</div>
            ...
            <div className="group relative bg-gradient-to-br from-[#242851] to-[#1e2142] p-5 rounded-xl hover:shadow-xl hover:shadow-purple-900/20 transition-all duration-300 border border-[#3a3f6a]/50 overflow-hidden">
              ...
              <div className="relative">
                ...
                <div className="text-white text-lg font-bold mb-2">Basic of cyber threat prevention</div>

                <div className="text-gray-300 text-sm mb-4 line-clamp-2">
                  Learn how to identify and prevent common cyber threats before they become a problem.
                </div>
            ...
            <div className="group relative bg-gradient-to-br from-[#242851] to-[#1e2142] p-5 rounded-xl hover:shadow-xl hover:shadow-purple-900/20 transition-all duration-300 border border-[#3a3f6a]/50 overflow-hidden">
              ...
              <div className="relative">
                ...
                <div className="text-white text-lg font-bold mb-2">Advanced Security Techniques</div>

                <div className="text-gray-300 text-sm mb-4 line-clamp-2">
                  Master advanced cybersecurity techniques used by professionals in the field.
                </div>

                <div className="flex items-center justify-between">
                  <div className="bg-purple-900/30 text-purple-300 text-xs px-3 py-1 rounded-full">Advanced</div>
        ...
        <div className="mt-16 mb-10">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-white text-2xl font-bold">Recommended Learning Path</h2>
          </div>
            ...
            <div className="space-y-6">
              <div className="relative pl-16">
                ...
                <div className="bg-[#242851]/70 p-5 rounded-xl border border-[#3a3f6a]/50">
                  <h3 className="text-white font-bold text-lg mb-2">Fundamental for Cyber</h3>
                  <p className="text-gray-300 text-sm">
                    Master the core concepts of cybersecurity to build a strong foundation for your learning journey.
                  </p>
                  <div className="mt-3">
                    <a
                      href="/courses/fundamental"
              ...
              <div className="relative pl-16">
                ...
                <div className="bg-[#242851]/70 p-5 rounded-xl border border-[#3a3f6a]/50">
                  <h3 className="text-white font-bold text-lg mb-2">Web Exploit Basic</h3>
                  <p className="text-gray-300 text-sm">
                    Learn how to identify and exploit common web vulnerabilities in a controlled environment.
                  </p>
                  <div className="mt-3">
                    <a
                      href="/courses/web-exploit"
              ...
              <div className="relative pl-16">
                ...
                <div className="bg-[#242851]/70 p-5 rounded-xl border border-[#3a3f6a]/50">
                  <h3 className="text-white font-bold text-lg mb-2">Basic of cyber threat prevention</h3>
                  <p className="text-gray-300 text-sm">
                    Develop skills to identify and prevent common cyber threats before they become a problem.
                  </p>
                  <div className="mt-3">
                    <a
                      href="/courses/threat-prevention"
