        ...
        <div className="text-white mt-8 mb-12">
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="w-full md:w-2/3 lg:w-3/4">
                ...
                <form className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        type="text"
                        className="w-full bg-[#161831] rounded-md py-2 px-3 text-white"
                    ...
                    <div>
                      ...
                      <input
                        type="date"
                        className="w-full bg-[#161831] rounded-md py-2 px-3 text-white mb-12"
                      />
                    </div>
                  </div>
                </form>
              ...
              {/* Additional settings section could be added here */}
              <div className="">
                {/* Password Settings moved to left side */}
              </div>
