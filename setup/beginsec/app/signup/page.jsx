    ...
    <div className="min-h-screen bg-gradient-to-b from-[#f5f5f7] to-[#e8e8ea] flex items-center justify-center p-8">
      <div className="bg-white rounded-3xl shadow-2xl overflow-hidden max-w-5xl w-full flex flex-col md:flex-row border border-gray-100">
        ...
        <div className="w-full md:w-6/12 bg-[#161831] relative h-64 md:h-auto">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-[#161831]/70 to-[#161831]/40 flex items-center justify-center">
            <div className="text-white text-center p-8">
              <h2 className="text-2xl md:text-4xl font-bold mb-3 drop-shadow-md">Create an Account</h2>
              <p className="text-sm md:text-base max-w-xs mx-auto">Join our cybersecurity community today</p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full md:w-6/12 p-8 md:p-10">
          <div className="mb-6">
            <h1 className="text-[#252525] text-2xl md:text-3xl font-bold mb-2">Sign Up</h1>
            <p className="text-gray-600 text-base">Please fill in your information</p>
          </div>
          ...
          <form className="flex flex-col gap-4">
            ...
            <div className="space-y-1">
              ...
              <div className={`${styles.input_group} transition-all duration-300 hover:shadow-md`}>
                <input
                  ...
                  className={`${styles.input_text} focus:border-[#391A81] focus:ring-2 focus:ring-[#391A81]/30 transition-all duration-300`}
                />
                <div className="absolute inset-y-0 right-3 flex items-center cursor-pointer text-xl text-gray-500 hover:text-[#391A81] transition-colors duration-300" onClick={toggleConfirmPasswordVisibility}>
                  {showConfirmPassword ? <IoMdEyeOff /> : <IoMdEye />}
                </div>
              </div>
            </div>

            <button className={`${styles.button} mt-4 py-3 text-base shadow-lg shadow-[#391A81]/20 hover:shadow-xl hover:shadow-[#391A81]/30 hover:-translate-y-0.5 transition-all duration-300`} type="submit">
              Sign up
            </button>
            ...
            <p className="text-center text-[#929BA4]">
              ...
              <Link href="/login" className="text-[#391A81] font-medium hover:underline transition-all duration-300">
                Login
              </Link>
            </p>
          </form>
